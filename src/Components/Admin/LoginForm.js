				...
				<div>
					<div>
						<div>
							...
							<input type="text" name="username" autoComplete="off" placeholder="Username" onChange={this.onChangeHandler} />
						</div>
					</div>
					<div>
						<div>
							<label>Password: </label>
							<input type="password" name="password" autoComplete="off" onChange={this.onChangeHandler} />
						</div>
					</div>
