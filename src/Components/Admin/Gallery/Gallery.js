		...
		return (
			<div className="create-gallery-dropbox">
				...
				>
					...
					<p>
						Type a name for the gallery you want to create. This is a simple title that will display above each gallery displayed in the gallery page.
						Then add some images you would like to upload to the gallery in the box below. Please restrict uploads to 6 images at a time for larger
						images. More images can be added to any gallery later in the edit gallery page (TODO).
					</p>
				</div>
