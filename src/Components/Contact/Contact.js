        ...
        <div className="contact">
          ...
          <div className="social-media">
            ...
            <a href="https://facebook.com/scubaforthesoul" target="new">
              <img
                src="http://floridivers.com/images/icons/fb.png"
                alt="FaceBook"
              />
            </a>
            <a href="https://twitter.com/@scubaforthesoul" target="new">
              <img
                src="http://floridivers.com/images/icons/twitter.png"
                alt="Twitter"
              />
            </a>
            <a
              href="https://www.instagram.com/explore/tags/scubaforthesoul/"
              target="new"
            >
              <img
                src="http://floridivers.com/images/icons/inst.png"
                alt="Instagram"
              />
            </a>
            <a
              href="https://www.youtube.com/channel/UC57qQD8U-ZGDKAbzFjllJ4A"
              target="new"
            >
              <img
                src="http://floridivers.com/images/icons/youtube.png"
                alt="YouTube"
              />
            </a>
          </div>
